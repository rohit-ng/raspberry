...
#define TSK_STACK_CANARY 1432 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 6800 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 7888 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 7784 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 7864 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 7880 /* offsetof(struct task_struct, thread.mte_ctrl) */
...
#define TRAMP_VALIAS -549793660928 /* TRAMP_VALIAS */
